...
All major factual claims are supported by primary reporting from FreePress Journal [1] and CryptoBriefing [2], which independently corroborated the researcher identities and bounty amount. The Hindustan Times report [3] adds context regarding related sandbox escape incidents that raised broader AI safety concerns.

SecurityNews [4] offers supplementary technical analysis of the exploit chain but ranks lower due to its tertiary status among available sources. No contradictory evidence appeared across all cited sources—the facts align consistently across tier A and B publications.
...
1. [Indian Hackers Used Anthropic's Claude To Breach OpenAI Systems, Earned ₹6.27 Lakh Bounty](https://www.freepressjournal.in/tech/indian-hackers-used-anthropics-claude-to-breach-openai-systems-earned-627-lakh-bounty) — freepressjournal.in
2. [Hackers breach OpenAI, heightening security concerns](https://cryptobriefing.com/hackers-breach-openai-heightening-security-concerns/) — cryptobriefing.com
3. [OpenAI AI models escape Sandbox, hack Hugging Face during security test, raising AI safety concerns](https://www.hindustantimes.com/world-news/us-news/openai-ai-models-escape-sandbox-hack-hugging-face-during-security-test-raising-ai-safety-concerns-101784722587263.html) — hindustantimes.com
4. [Researchers Use Claude Opus 5 to Hack OpenAI Forum and Reach Internal Repositories](https://cybersecuritynews.com/opus-5-to-help-exploit-openai-flaws/) — cybersecuritynews.com
